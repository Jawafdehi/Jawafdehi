...
// calibrated 612×344 artwork the static fallback shows) onto a sphere, then
// animates arcs from 15 cities with large Nepali communities into a labeled
// काठमाडौँ · Nepal beacon. Slow auto-spin, drag to rotate, pauses offscreen.
// Kathmandu is always labeled so the geography is never ambiguous.
