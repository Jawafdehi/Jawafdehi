        ...
        <section className="border-b bg-muted/20">
          <div className="layout-container py-12 md:py-16">
            ...
            <p className="mt-4 text-sm italic text-muted-foreground/80">
              {t("research.corruption.hero.snapshot", "Based on a 14-fiscal-year analysis of court records (FY2069/70–2082/83) and the CIAA's annual reports through FY2081/82, the most recent published.")}{" "}
              <a
                href="#methodology"
                onClick={(e) => {
