    ...
    return (
        ...
        >
            {article.thumbnail?.url ? (
                ...
                <div className="flex aspect-video items-center justify-center border-b border-border/70 bg-gradient-to-br from-secondary via-muted to-background text-primary md:data-[view=list]:w-80 md:data-[view=list]:shrink-0 md:data-[view=list]:self-start md:data-[view=list]:border-b-0 md:data-[view=list]:border-r" data-view={viewMode}>
