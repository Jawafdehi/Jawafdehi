...
export interface Case {
  ...
  // First-instance court: registration and verdict.
  trial_start_date: string | null; // ISO date format
  trial_end_date: string | null; // ISO date format
  // Supreme Court appeal: registration and verdict. Both null when the verdict
  // was never appealed.
  appeal_start_date: string | null; // ISO date format
  appeal_end_date: string | null; // ISO date format
