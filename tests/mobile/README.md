...
| `prove-nav-unreachable.mjs` | Worked example of *proving* a reachability defect: tries wheel, CDP touch-scroll, drag, Tab-focus-scroll, `scrollIntoView()` and `.click()`, plus a tall-viewport control. |
